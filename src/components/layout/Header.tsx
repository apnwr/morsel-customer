              ...
              isCartPage || isOrdersPage ? (
                ...
                <div className="relative shrink-0 h-[59px]">
                  ...
                  <button
                    ...
                    className={`relative overflow-hidden w-[211px] h-[50px] bg-[#F8F8F8] rounded-[30px] transition-colors mt-[9px] ${isCartEmpty
                  ...
                  >
                    <AnimatePresence initial={false} mode="sync">
                      {snackbar ? (
                        ...
                        >
                          <span
                            className={`text-xl font-black ${isCartEmpty ? 'text-[#B2B2B2]' : 'text-black'
                              }`}
            ...
            <div className="flex items-center gap-2 shrink-0">
              {isCartPage || isOrdersPage ? (
                ...
                <button
                  ...
                  className={`relative w-[50px] h-[50px] flex items-center justify-center rounded-full border-[3px] ${placedOrdersCount > 0
